// src/components/common/AffiliationCollectionSelector
// 
// .tsx
'use client';
...
const AffiliationCollectionSelector

    : React.FC<CollectionSelectorProps> = ({
        label,
        options,
        selectedValue,
        onSelect,
...
export default AffiliationCollectionSelector