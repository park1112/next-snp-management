                            ...
                            {paginatedFields.map((field) => (
                                ...
                                >
                                    <Box sx={{ display: 'table-cell', py: 2, px: 2, borderBottom: 1, borderColor: 'divider' }}>
                                        <Typography variant="body2" noWrap>{field.address.full}</Typography>
                                    </Box>
                                    <Box sx={{ display: 'table-cell', py: 2, px: 2, borderBottom: 1, borderColor: 'divider' }}>
                                        <Typography variant="body2">{field.farmerName || '-'}</Typography>
                                    </Box>
                                    <Box sx={{ display: 'table-cell', py: 2, px: 2, borderBottom: 1, borderColor: 'divider' }}>
                                        <Typography variant="body2">{field.cropType}</Typography>
                                    </Box>
                                    <Box sx={{ display: 'table-cell', py: 2, px: 2, borderBottom: 1, borderColor: 'divider' }}>
                                        <Typography variant="body2">{field.area.value} {field.area.unit}</Typography>
                                    </Box>
                                    <Box sx={{ display: 'table-cell', py: 2, px: 2, borderBottom: 1, borderColor: 'divider' }}>
                                        <Chip
                                            size="small"
