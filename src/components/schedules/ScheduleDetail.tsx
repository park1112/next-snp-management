                        ...
                        <CardContent>
                            ...
                            <Box sx={{ mb: 2 }}>
                                ...
                                <Typography variant="body1">
                                    {format(schedule.scheduledDate.start, 'yyyy년 M월 d일(E) HH:mm', { locale: ko })}
                                </Typography>
                            </Box>
                    ...
                    <Card variant="outlined" sx={{ mb: 3 }}>
                        <CardContent>
                            ...
                            <Box sx={{ mb: 2 }}>
                                ...
                                <Typography variant="body1">
                                    {schedule.rateInfo.baseRate.toLocaleString()}원 / {schedule.rateInfo.unit}
                                </Typography>
                            </Box>
                            
                            {schedule.rateInfo.negotiatedRate && (
                                <Box sx={{ mb: 2 }}>
                                    <Typography variant="body2" color="text.secondary">
                                        협의 단가
                                    </Typography>
                                    <Typography variant="body1">
                                        {schedule.rateInfo.negotiatedRate.toLocaleString()}원 / {schedule.rateInfo.unit}
                                    </Typography>
                                </Box>
                            )}
                            
                            {schedule.rateInfo.quantity && (
                                <Box sx={{ mb: 2 }}>
                                    <Typography variant="body2" color="text.secondary">
                                        작업량
                                    </Typography>
                                    <Typography variant="body1">
                                        {schedule.rateInfo.quantity.toLocaleString()} {schedule.rateInfo.unit}
                                    </Typography>
                                </Box>
                            )}
                    ...
                    <Card variant="outlined" sx={{ mb: 3 }}>
                        <CardContent>
                            ...
                            <Timeline position="right" sx={{ m: 0, p: 0 }}>
                                {schedule.stage.history && schedule.stage.history.map((item, index) => (
